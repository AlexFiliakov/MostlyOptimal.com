...
async function onRequestPost(context) {
  ...
  try {
    ...
    if (data.message.length < 10 || data.message.length > 5e3) {
      return new Response(
        JSON.stringify({
          success: false,
...
// ../.wrangler/tmp/pages-4MqWtB/functionsRoutes-0.00567083650623923.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-fHKLwo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fHKLwo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.32011270549924564.mjs.map
